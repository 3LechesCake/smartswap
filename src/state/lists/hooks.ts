...
import DEFAULT_TOKEN_LIST from "../../utils/constants/tokenList/tresleches-default.tokenList.json"
...
import UNSUPPORTED_TOKEN_LIST from '../../utils/constants/tokenList/tresleches-unsupported.tokenlist.json'
...
function combineMaps(map1: TokenAddressMap,  map2: TokenAddressMap): TokenAddressMap {
  return {
    ...
    13381: {...map1[13381], ...map2[13381] }, // phoenix mainnet
    2000: {...map1[2000], ...map2[2000] }, // doge mainnet
    6066: {...map1[6066], ...map2[6066] }, // tresleches mainnet
    6065: {...map1[6065], ...map2[6065] }, // tresleches testnet
  }
}
