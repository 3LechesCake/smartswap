...
export default function AddLiquidity({
  ...
  const approveButtonBgColor = useColorModeValue("#ce0014", "#4CAFFF");
  const approveButtonColor = useColorModeValue("#FFFFFF", "#F1F5F8");

  const { independentField, typedValue, otherTypedValue } = useMintState();
  //const [loading, setLoading] = useState(false);
  const [run, setRun] = useState(false);
  const bgColorRide = useColorModeValue("#ce0014", "#4CAFFF");
     ...
     <Box
      ...
      >
        ...
        <Box bg={infoBg} borderRadius="md" p={4} mt={4} mb={5}>
          <Text color='#ce0014' fontWeight="400" fontSize="14px">
