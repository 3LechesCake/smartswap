...
const LiquidityDetails = (props: LiquidityDetail) => {
  ...
  const addButtonBgColor = useColorModeValue("#ce0014", "#4CAFFF");
  const addButtonColor = useColorModeValue("#FFFFFF", "#F1F5F8");
  const removeButtonBorderColor = useColorModeValue("#ce0014", "#4CAFFF");
  const removeButtonBgColor = useColorModeValue("#FFFFFF", "#15202B");
  const removeButtonColor = useColorModeValue("#ce0014", "#4CAFFF");
  const bgColor = useColorModeValue("#fff7ea", "#15202B");
