...
import Darklogo from "../../assets/TRESdarklogo.png";
      ...
      >
        <Flex justifyContent='space-between' width='100%'>
          ...
          <Flex justifyContent={'space-between'} marginTop='15px' align='left' alignItems={'center'}>
            {content?.type === "TRES" ? content.deposit : content2?.deposit}
        ...
        <Flex justifyContent='space-between' width='100%'>
          ...
          >
            ...
            <Text marginLeft='10px'>
              {content?.type === "TRES" ? content.earn : content2?.earn}
            </Text>
          </Flex>
        </Flex>
        <Flex justifyContent='space-between' width='100%'>
      ...
      {showYieldfarm && (
          ...
          !selected ? (
              <ShowYieldFarmDetails
                  content={content?.type === "TRES" ? content : content2}
                  // content2={content2}
