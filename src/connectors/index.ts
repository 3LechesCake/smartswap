...
export const RPC = {
  ...
  [SupportedChainId.DOGEMAINNET]: "https://rpc01.dogechain.dog",
  [SupportedChainId.TRESMAINNET]: "https://rpc.tresleches.finance",
  [SupportedChainId.TRESTESTNET]: "https://rpc-test.tresleches.finance",
};
...
const supportedChainIds = [3, 4, 56, 97, 80001, 137, 13381, 2000, 6066, 6065];
