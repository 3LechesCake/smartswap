...
const Filter = ({
  ...
  const activeButtonColor = useColorModeValue("#ce0014", "#4CAFFF");
  const inputRightAddOnBgColor = useColorModeValue("#F2F5F8", "");
  const filterSelected = useColorModeValue("#DEE5ED", "#008DFF");
  const checkIconColor = useColorModeValue("#ce0014", "#ce0014");
  const sliderFilledTrackBgColor = useColorModeValue("#ce0014", "#ce0014");
  const buttonBgColor = useColorModeValue("#DEE5ED", "#213345");
  const lastButtonColor = useColorModeValue("#FFFFFF", "#15202B");
  const lastButtonBgColor = useColorModeValue("#4CAFFF", "#ce0014");
