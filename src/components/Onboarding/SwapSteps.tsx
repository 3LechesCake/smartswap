...
export const tourSteps = [
  ...
  },
  {
    ...
    content: <ContentBox>This is the DApps dropdown, it is used to navigate to other DApps on TRES network</ContentBox>,
...

  {
    ...
    content: <ContentBox>These links lead to individual products under the TRES SmartSwap DApp.</ContentBox>,
    placement: "left-end",
    locale: {
      next: <NextBtn />,
      back: <BackBtn />,
...

  {
    ...
    content: <ContentBox>This shows the networks supported by TRES so you can change to any of them by clicking on it.</ContentBox>,
    locale: {
      next: <NextBtn />,
      back: <BackBtn />,
      close: <CloseBtn />,
