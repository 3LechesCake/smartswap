...
const ManageList: React.FC<IModal> = ({
  ...
  const borderColor = useColorModeValue('#ce0014', '#4CAFFF');
  ...
  const boxColor2 = useColorModeValue("#ce0014", "#213345")
  const backgroundColor = useColorModeValue("#ffffff", "#ce0014")
  const color = useColorModeValue("#ce0014", "#ffffff")
