...
export const switchNetwork = async (
  ...
  const dogechainParams = {
    ...
    rpcUrls: ["https://rpc01.dogechain.dog"],
    blockExplorerUrls: ["https://explorer.dogechain.dog"],
  };

  const phoenixParams = {
    chainId: "0x3445",
    chainName: "Phoenix Mainnet",
    nativeCurrency: {
      name: "Phoenix",
      symbol: "PHX",
      decimals: 18,
  ...
  const trestestParams = {
    chainId: "0X17B2",
    chainName: "TRES Testnet",
    nativeCurrency: {
      name: "TRES",
      symbol: "TRES",
      decimals: 18,
    },
    rpcUrls: ["http://rpc-test.tresleches.finance"],
    blockExplorerUrls: ["https://treschain.co"],
  };
  const tresParams = {
    chainId: "0X17B3",
    chainName: "TRES Mainnet",
    nativeCurrency: {
      name: "TRES",
      symbol: "TRES",
      decimals: 18,
    },
    rpcUrls: ["http://rpc.tresleches.finance"],
